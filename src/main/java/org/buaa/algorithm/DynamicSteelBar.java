...
public class DynamicSteelBar {
     ...
     * @return 最大收益
     */
    public static int memoized_cut_aux(int[] p, int n, int[] r) {
     ...
     * @param s 切割方案数组
     */
    public static void extended_button_up_cut_rod(int[] p, int n, int[] r, int[] s) {
    ...
    public static void main(String[] args) {
        int[] p = new int[]{0, 1, 5, 8, 9, 10, 10, 17, 17, 20, 24, 30};
        int n = 10;
        //cut_rod(p, n);
